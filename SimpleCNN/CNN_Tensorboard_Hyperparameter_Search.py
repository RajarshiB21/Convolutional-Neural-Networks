...
for batch_size in batch_sizes:
    for learning_rate in learning_rates:
        ...
        writer = SummaryWriter(f'runs/MNIST/MiniBatchSizes {batch_sizes} LR {learning_rate}')
        #Train the Network
        ...
        for epoch in range(num_epochs):
            ...
            for batch_idx, (data,targets) in loop:
                ...
                ##Visualises how the weights change as we train it
            ...
            writer.add_hparams({'lr': learning_rate, 'bsize': batch_size},
                                {'acccuracy': sum(accuracies) / len(accuracies),
